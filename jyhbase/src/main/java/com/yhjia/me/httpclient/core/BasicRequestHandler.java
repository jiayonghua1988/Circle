...
/**
 * Default {@link RequestHandler} used by {@link }. It is
...
public abstract class BasicRequestHandler implements RequestHandler {
    ...
    public void writeHeaders(HttpURLConnection urlConnection, HttpMethod httpMethod) {
        ...
        if (params != null) {
            ArrayList<ParameterList.HeaderParameter> headList = params.getHeaderParams();
            for (ParameterList.HeaderParameter param : headList) {
        ...
        try {
            ...
            if (params != null) {
                if (params.hasMultiPart()) {
                    ...
                    for (ParameterList.Parameter par : params) {
                        if (par instanceof ParameterList.StringParameter) {
                            ParameterList.StringParameter strPar = (ParameterList.StringParameter) par;
                        ...
                        if (par instanceof ParameterList.FileParameter) {
                            ParameterList.FileParameter filePar = (ParameterList.FileParameter) par;
                        ...
                        if (par instanceof ParameterList.InputStreamParameter) {
                            ParameterList.InputStreamParameter ipsPar = (ParameterList.InputStreamParameter)par;
                            dos.writeBytes("--" + AbsHttpClient.BOUNDARY + AbsHttpClient.CRLF);
