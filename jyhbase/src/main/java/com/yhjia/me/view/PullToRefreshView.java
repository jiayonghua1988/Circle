...
public class PullToRefreshView extends LinearLayout {
	...
	private static boolean ISHEADREFRESHING = true;
	private static boolean ISFOOTREFRESHING = true;
	private int DOWNY = 0;
	public int getDOWNY() {
		return DOWNY;
	}
...
//	private String mLastUpdateTime;
    ...
    public void closeHeadRefresh(){
    	ISHEADREFRESHING = false;
    }
    public void openHeadRefresh(){
    	ISHEADREFRESHING = true;
    }
    public void closeFootRefresh(){
    	ISFOOTREFRESHING = false;
    }
    public void openFootRefresh(){
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (isRefreshViewScroll(deltaY)&&ISREFRESHING) {
				return true;
			}
			break;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			int deltaY = y - mLastMotionY;
			if (mPullState == PULL_DOWN_STATE&&ISHEADREFRESHING) {
				// PullToRefreshView执行下拉
				Log.i(TAG, " pull down!parent view move!");
				headerPrepareToRefresh(deltaY);
//				 setHeaderPadding(-mHeaderViewHeight);
			} else if (mPullState == PULL_UP_STATE&&ISFOOTREFRESHING) {
